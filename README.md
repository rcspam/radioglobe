...
- The local time where the station broadcasts sits at the end of the station name (zone picked from the system's `zone1970.tab` by country and nearest reference city; hover it for the zone name and UTC offset). Names and titles too wide for the player slide back and forth instead of being cut
