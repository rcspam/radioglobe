...
- While a search is active the globe shows the matches only, so typing a tag such as "jazz" maps where those stations are; clearing the search brings the world back
