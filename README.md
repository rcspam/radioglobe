...
- A home country (taken from your locale, or set in the widget's configuration): all of its geolocated stations are always loaded and kept on the globe, however popular they are
