...
- The player's second line ends with the local time where the station broadcasts (zone picked from the system's `zone1970.tab` by country and nearest reference city; hover the station for the zone name and UTC offset)
